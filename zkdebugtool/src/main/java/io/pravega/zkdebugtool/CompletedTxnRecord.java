...
public class CompletedTxnRecord {
    ...
    public static io.pravega.controller.store.stream.tables.CompletedTxnRecord parse(final byte[] bytes) {
        ...
        return new io.pravega.controller.store.stream.tables.CompletedTxnRecord(completeTimeStamp, status);
    }
