...
public class ActiveTxnRecord {
    ...
    public static io.pravega.controller.store.stream.tables.ActiveTxnRecord parse(final byte[] bytes) {
        ...
        return new io.pravega.controller.store.stream.tables.ActiveTxnRecord(txCreationTimestamp, leaseExpiryTime, maxExecutionExpiryTime, scaleGracePeriod, status);
    }
